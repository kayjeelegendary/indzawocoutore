...
var doneLoading = function doneLoading() {
  ...
  storyField.text = "This is just 1 out of a million \n  ways we chose to remember Nomfundo Myeza "

  storyField.text += "The Herione we mourning and celebrating. \n"
  storyField.text += "Cheers to all the good times we shared together with her\n  "
  storyField.text += "Nomfundo Your life was a gift to the world \n "
  storyField.text += "The little rabbit is carring our love \n"
storyField.text += "For You our heroine,and the carrots are minor obsticals in our way \n"
storyField.text += "For in the end we will link up again and share more wonderful moments \n"
storyField.text += "To the myeza family we send our deepest condolences and support \n."
...
var onFaint = function onFaint(e) {
  ...
  stage.update(e);
  messageField.text = 'You are always loved & never forgotten. Rest easy, Nomfundo! Score: ' + scoreField.text + '\n Click to play again';
  stage.addChild(messageField);
  watchForRestart();
};
